...
export default function FstDashboard() {
  ...
  // Filter laboratories to only show FST labs
  const fstLaboratories = useMemo(() => {
    return (laboratories || []).filter((l) => getRumpun(l) === "FST");
  }, [laboratories, getRumpun]);

  const handleShare = () => {
    if (navigator.share) {
      navigator.share({
        title: 'FST UIN Jakarta - Fakultas Sains dan Teknologi',
        text: 'Akses berbagai fasilitas laboratorium FST untuk mendukung kegiatan praktikum, penelitian, dan pembelajaran Anda.',
        ...
        >
          ...
          <div className="hero-content">
            ...
            <h3 className="hero-subtitle">
              Rumpun Laboratorium FST
            </h3>
            <p className="hero-description">
              Akses berbagai fasilitas laboratorium FST dan reka cipta sains untuk mendukung kegiatan praktikum, penelitian, dan pembelajaran dengan peralatan berstandar tinggi.
            </p>
          </div>
        </div>
        ...
        <div className="hero-stats-card">
          ...
          <div className="hero-stat-item">
            ...
            <div className="text-left">
              <div className="hero-stat-value">{fstLaboratories.length}</div>
              <div className="hero-stat-label">Lab FST</div>
            </div>
          </div>
      ...
      <section className="labs-section">
        ...
        <div className="labs-header">
          <span className="labs-section-tag">
            — Pilih Ruang Laboratorium FST —
          </span>
          <h3 className="labs-section-title">
            Silahkan Pilih Ruang Laboratorium FST
          </h3>
          <p className="labs-section-subtitle">
            Pilih ruang laboratorium FST yang akan digunakan sesuai kebutuhan Anda
          </p>
        </div>

        {/* Lab Cards Grid */}
        <div className="labs-grid">
          {fstLaboratories.map((lab) => renderCard(lab))}
        </div>
      </section>
    </DashboardLayout>
  );
