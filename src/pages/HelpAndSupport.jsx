 ...
 * Ported from Dashboard B (ContactSupport.jsx) with enhanced UX.
 */
export default function HelpAndSupport() {
  ...
  return (
    <div className="px-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-800">Kontak & Bantuan</h2>
        <p className="text-gray-400 text-xs font-medium mt-1">
          Punya pertanyaan atau kendala seputar lab? Tim admin kami siap
          membantu.
        </p>
      </div>
          ...
          <div className="md:col-span-2 bg-white p-5 border border-gray-100 rounded-2xl shadow-sm">
            ...
            <form className="space-y-3" onSubmit={handleSubmitMessage}>
              ...
              <textarea
                ...
                required
                className="w-full p-2.5 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-600 bg-gray-50 resize-none"
              />
              <button
                type="submit"
