    ...
    reader.onload = (event) => {
      try {
        ...
        const indices = {
          ...
          dosen: getColIdx(["dosen", "nama dosen", "pengampu"]),
        ...
        if (indices.hari === -1 || indices.jam === -1 || indices.matkul === -1 || indices.dosen === -1) {
          setImportError("Kolom data minimal tidak ditemukan. Pastikan file template memiliki kolom: 'Hari', 'Jam', 'Mata Kuliah', dan 'Nama Dosen'.");
          return;
        }
